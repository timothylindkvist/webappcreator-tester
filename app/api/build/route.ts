...
const OutputSchema = z.object({
  ...
  cta: z.object({
    heading: z.string(),
    subheading: z.string(),
    primary: z.object({ label: z.string() })
  })
});

// Configure OpenAI client
// - OPENAI_API_KEY is required
// - OPENAI_BASE_URL is optional (use your Vercel AI Gateway Base URL if you want traffic routed through it)
const openai = createOpenAI({
  apiKey: process.env.OPENAI_API_KEY,
  baseURL: process.env.OPENAI_BASE_URL, // fallback to api.openai.com if unset
});
